    ...
    <header className="hero" id="top">
      <div className="wrap hero__wrap">
        ...
        <div className="hero__content">
          <p className="hero__switch-label">✦ switch view to see a different side of me</p>
          ...
          <div key={persona.key} className="hero__fade">
            ...
            <div className="hero__cta">
              ...
              <a href={contact.resume} download className="btn btn--ghost">Download Resume</a>
              <a href={contact.linkedin} target="_blank" rel="noreferrer" className="btn btn--ghost">LinkedIn</a>
            </div>

            <p className="hero__meta">{contact.location} · open to relocation · try pressing 1, 2, or 3</p>
          </div>
        </div>
